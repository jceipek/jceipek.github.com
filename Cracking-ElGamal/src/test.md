...
<button class="graphite-flat-button js-attack-example-pick-p">Click to pick a random m</button>

Assuming that %%b = %% <span class="TKAdjustableNumber" data-var="bBits" data-min="8" data-max="64"></span> bits and that %%b_1 = %% <span class="TKAdjustableNumber" data-var="b1Bits" data-min="2" data-max="64"></span> bits meaning that %%b_2=%% <span data-var="b2Bits"></span> bits,
